...
function init()
  ...
  terminalButton = modules.client_topmenu.addLeftButton('terminalButton', tr('Terminal') .. ' (Ctrl + Shift + V)', '/images/topbuttons/terminal', toggle)
...
function terminate()
  ...
  g_keyboard.unbindKeyDown('Ctrl+Shift+V')
