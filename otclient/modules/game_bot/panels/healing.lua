...
Panels.Haste = function(parent)
  ...
  context.addTextEdit("autoHasteText", context.storage.autoHasteText or "concentrate chakra feet", function(widget, text)    
...
Panels.AntiParalyze = function(parent)
  ...
  context.addTextEdit("autoAntiParalyzeText", context.storage.autoAntiParalyzeText or "concentrate chakra feet", function(widget, text)    
