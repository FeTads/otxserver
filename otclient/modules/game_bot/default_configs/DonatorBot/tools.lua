...
addTextEdit("Kunai", storage.Kunai or "7382", function(widget, text) storage.Kunai = text
end,scpPanel)
...
jumpp= macro(2, "Auto JUMP", "shift+q", function()
  local playerPos = pos()
  local levitateTile
...
gpAntiPushDrop = macro(dropDelay , "Anti-Push", "shift+d+9", function ()
  antiPush()
end,scpPanel)
...
if type(storage.manatrainer) ~= "table" then
  storage.manatrainer = {on=false, title="mana%", text="Treinar Chakra", min=0, max=90}
end
...
macro(20, "Dance", function()
    turn(math.random(0, 3))
        ...
        cor= UI.Label("- PK TIME -",scpPanel5)
cor:setColor("blue")
  ...
  for _, x in ipairs(getSpectators(true)) do
   if x:isPlayer() and q.nk == x:getName() then
    if x:getHealthPercent() == 0 then
     storage.TimeRemain = now + (storage.pkz * 60 * 1000)
...
addTextEdit("pkz", storage.pkz or "Tempo do PK 1 minuto = 60", function(widget, text) storage.pkz = text
        ...
        cor= UI.Label("- Sense Position -",scpPanel5)
cor:setColor("#00FFFF")
...
addTextEdit("pp", storage.pp or "Position da tela x", function(widget, text) storage.pp = text
end,scpPanel5)

addTextEdit("pc", storage.pc or "Position da tela y", function(widget, text) storage.pc = text
end,scpPanel5)
...
local moveTime = 100     -- Wait time between Move, 2000 milliseconds = 2 secondsss
...
TabBar2:addTab("Combo", cmbPanel)
        color= UI.Label("by: @Donator",cmbPanel)
...
addTextEdit("Combo7Text", storage.Combo7Text or "magia 8", function(widget, text) storage.Combo7Text = text
end,cmbPanel)
addTextEdit("Combo8Text", storage.Combo8Text or "magia 9", function(widget, text) storage.Combo8Text = text
end,cmbPanel)
addTextEdit("Combo9Text", storage.Combo9Text or "magia 10", function(widget, text) storage.Combo9Text = text
end,cmbPanel)
addTextEdit("Combo10Text", storage.Combo10Text or "magia 11", function(widget, text) storage.Combo10Text = text
end,cmbPanel)
addTextEdit("Combo11Text", storage.Combo11Text or "magia 12", function(widget, text) storage.Combo11Text = text
end,cmbPanel)


TabBar2:addTab("Combo UP", cmbPanel2)
        color= UI.Label("by: @Donator",cmbPanel2)
color:setColor("orange")
...
addTextEdit("UP1", storage.UP1 or "magia 1", function(widget, text) 
storage.UP1 = text
end,cmbPanel2)
addTextEdit("UP2", storage.UP2 or "magia 2", function(widget, text) storage.UP2 = text
end,cmbPanel2)
addTextEdit("UP3", storage.UP3 or "magia 3", function(widget, text) storage.UP3 = text
end,cmbPanel2)
addTextEdit("UP4", storage.UP4 or "magia 4", function(widget, text) storage.UP4 = text
end,cmbPanel2)
addTextEdit("UP5", storage.UP5 or "magia 5", function(widget, text) storage.UP5 = text
end,cmbPanel2)
addTextEdit("UP6", storage.UP6 or "magia 6", function(widget, text) storage.UP6 = text
end,cmbPanel2)
addTextEdit("UP7", storage.UP7 or "magia 7", function(widget, text) storage.UP7 = text
end,cmbPanel2)
addTextEdit("UP8", storage.UP8 or "magia 8", function(widget, text) storage.UP8 = text
end,cmbPanel2)
addTextEdit("UP9", storage.UP9 or "magia 9", function(widget, text) storage.UP9 = text
end,cmbPanel2)
addTextEdit("UP10", storage.UP10 or "magia 10", function(widget, text) storage.UP10 = text
end,cmbPanel2)
addTextEdit("UP11", storage.UP11 or "magia 11", function(widget, text) storage.UP11 = text
end,cmbPanel2)
addTextEdit("UP12", storage.UP12 or "magia 12", function(widget, text) storage.UP12 = text
end,cmbPanel2)
addTextEdit("UP", storage.UP or "magia em area!", function(widget, text) storage.UP = text
end,cmbPanel2)



TabBar2:addTab("Combo 2", cmbPanel3)
        color= UI.Label("by: @Donator",cmbPanel3)
color:setColor("orange")
...
addTextEdit("Combo1", storage.Combo1 or "magia 1", function(widget, text) 
storage.Combo1 = text
end,cmbPanel3)
addTextEdit("Combo2", storage.Combo2 or "magia 2", function(widget, text) storage.Combo2 = text
end,cmbPanel3)
addTextEdit("Combo3", storage.Combo3 or "magia 3", function(widget, text) storage.Combo3 = text
end,cmbPanel3)
addTextEdit("Combo4", storage.Combo4 or "magia 4", function(widget, text) storage.Combo4 = text
end,cmbPanel3)
addTextEdit("Combo5", storage.Combo5 or "magia 5", function(widget, text) storage.Combo5 = text
end,cmbPanel3)
addTextEdit("Combo6", storage.Combo6 or "magia 6", function(widget, text) storage.Combo6 = text
end,cmbPanel3)
addTextEdit("Combo7", storage.Combo7 or "magia 7", function(widget, text) storage.Combo7 = text
end,cmbPanel3)
addTextEdit("Combo8", storage.Combo8 or "magia 8", function(widget, text) storage.Combo8 = text
end,cmbPanel3)
addTextEdit("Combo9", storage.Combo9 or "magia 9", function(widget, text) storage.Combo9 = text
end,cmbPanel3)
addTextEdit("Combo10", storage.Combo10 or "magia 10", function(widget, text) storage.Combo10 = text
end,cmbPanel3)
addTextEdit("Combo11", storage.Combo11 or "magia 11", function(widget, text) storage.Combo11 = text
end,cmbPanel3)
addTextEdit("Combo12", storage.Combo12 or "magia 12", function(widget, text) storage.Combo12 = text
end,cmbPanel3)
...
UI.Separator()
UI.Separator(scpPanel4)
macro(100, "Reta Ataque", "shift+f+8", function()
...
TabBar:addTab("HP", hpPanel)
        color= UI.Label("by: @Donator",hpPanel)
color:setColor("orange")
...
TabBar:addTab("Potion", hpPanel2)
        color= UI.Label("by: @Donator",hpPanel2)
color:setColor("orange")
...
TabBar:addTab("Haste", hpPanel3)
        color= UI.Label("by: @Donator",hpPanel3)
color:setColor("orange")
...
TabBar:addTab("Buff", hpPanel4)
        color= UI.Label("by: @Donator",hpPanel4)
color:setColor("orange")
...
TabBar:addTab("Fuga", hpPanel5)
        color= UI.Label("by: @Donator",hpPanel5)
color:setColor("orange")
...
TabBar:addTab("Food", hpPanel6)
        color= UI.Label("by: @Donator",hpPanel6)
color:setColor("orange")
...
TabBar:addTab("Equip", hpPanel7)
        color= UI.Label("by: @Donator",hpPanel7)
color:setColor("orange")
...
TabBar3:addTab("Time", tmsPanel)
        color= UI.Label("by: @Donator",tmsPanel)
color:setColor("orange")
...
addTextEdit("z1Text", storage.z1Text or "position para cima / baixo", function(widget, text) storage.z1Text = text
end,tmsPanel)
addTextEdit("yy1Text", storage.yy1Text or "position para os lados", function(widget, text) storage.yy1Text = text
end,tmsPanel)
...
TabBar3:addTab("Time 2", tmsPanel2)
        color= UI.Label("by: @Donator",tmsPanel2)
color:setColor("orange")
...
addTextEdit("zText", storage.zText or "position para cima / baixo", function(widget, text) storage.zText = text
end,tmsPanel2)
addTextEdit("yyText", storage.yyText or "position para os lados", function(widget, text) storage.yyText = text
end,tmsPanel2)
...
TabBar3:addTab("Time 3", tmsPanel3)
        color= UI.Label("by: @Donator",tmsPanel3)
color:setColor("orange")
...
addTextEdit("z2Text", storage.z2Text or "position para cima / baixo", function(widget, text) storage.z2Text = text
end,tmsPanel3)
addTextEdit("yy2Text", storage.yy2Text or "position para os lados", function(widget, text) storage.yy2Text = text
end,tmsPanel3)
...
TabBar3:addTab("Time 4", tmsPanel4)
        color= UI.Label("by: @Donator",tmsPanel4)
color:setColor("orange")
...
addTextEdit("z3Text", storage.z3Text or "position para cima / baixo", function(widget, text) storage.z3Text = text
end,tmsPanel4)
addTextEdit("yy3Text", storage.yy3Text or "position para os lados", function(widget, text) storage.yy3Text = text
end,tmsPanel4)
...
TabBar3:addTab("Time 5", tmsPanel5)
        color= UI.Label("by: @Donator",tmsPanel5)
color:setColor("orange")
...
addTextEdit("z4Text", storage.z4Text or "position para cima / baixo", function(widget, text) storage.z4Text = text
end,tmsPanel5)
addTextEdit("yy4Text", storage.yy4Text or "position para os lados", function(widget, text) storage.yy4Text = text
end,tmsPanel5)
...
TabBar3:addTab("-------- Cronometro --------", croPanel)
        color= UI.Label("by: @Donator",croPanel)
color:setColor("orange")
...
widgetTC.lblTimer:setText('Cronometro')
        ...
        playSound("/data/sounds/abertura.ogg")
...
testee = addButton("a", "Musica 1", true, rightPanel)
if true then
if not settings.a then end
  testee.onClick = function(widget)
playSound("/data/sounds/travis.ogg")
end
end

testee = addButton("b", "Musica 2", true, rightPanel)
if true then
if not settings.b then end
  testee.onClick = function(widget)
playSound("/data/sounds/funksid.ogg")
end
end

testee = addButton("c", "Musica 3", true, rightPanel)
if true then
if not settings.c then end
  testee.onClick = function(widget)
playSound("/data/sounds/imaginando.ogg")
end
end

testee = addButton("d", "Musica 4", true, rightPanel)
if true then
if not settings.d then end
  testee.onClick = function(widget)
playSound("/data/sounds/liluzi.ogg")
end
end

testee = addButton("e", "Musica 5", true, rightPanel)
if true then
if not settings.e then end
  testee.onClick = function(widget)
playSound("/data/sounds/mamonas.ogg")
end
end

testee = addButton("f", "Musica 6", true, rightPanel)
if true then
if not settings.f then end
  testee.onClick = function(widget)
playSound("/data/sounds/money.ogg")
end
end

testee = addButton("g", "Musica 7", true, rightPanel)
if true then
if not settings.g then end
  testee.onClick = function(widget)
playSound("/data/sounds/paparazi.ogg")
end
end


testee = addButton("h", "Musica 8", true, rightPanel)
if true then
if not settings.h then end
  testee.onClick = function(widget)
playSound("/data/sounds/suicide.ogg")
end
end



testee = addButton("i", "Musica 9", true, rightPanel)
if true then
if not settings.i then end
  testee.onClick = function(widget)
playSound("/data/sounds/hold.ogg")
end
end


testee = addButton("j", "Musica 10", true, rightPanel)
if true then
if not settings.j then end
  testee.onClick = function(widget)
playSound("/data/sounds/oceans.ogg")
end
end

testee = addButton("k", "Musica 11", true, rightPanel)
if true then
if not settings.k then end
  testee.onClick = function(widget)
playSound("/data/sounds/3.ogg")
end
end

testee = addButton("l", "Musica 12", true, rightPanel)
if true then
if not settings.l then end
  testee.onClick = function(widget)
playSound("/data/sounds/kingston.ogg")
end
end


testee = addButton("m", "Musica 13", true, rightPanel)
if true then
if not settings.m then end
  testee.onClick = function(widget)
playSound("/data/sounds/floor.ogg")
end
end

testee = addButton("n", "Musica 14", true, rightPanel)
if true then
if not settings.n then end
  testee.onClick = function(widget)
playSound("/data/sounds/drive.ogg")
end
end

testee = addButton("o", "Musica 15", true, rightPanel)
if true then
if not settings.o then end
  testee.onClick = function(widget)
playSound("/data/sounds/bala.ogg")
end
end

testee = addButton("p", "1 hora trap", true, rightPanel)
if true then
if not settings.p then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horatrap.ogg")
end
end

testee = addButton("q", "1 hora de funk", true, rightPanel)
if true then
if not settings.q then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horafunk.ogg")
end
end

testee = addButton("r", "1 hora de funk remix", true, rightPanel)
if true then
if not settings.r then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horaremix.ogg")
end
end

testee = addButton("s", "1 hora de Tauz", true, rightPanel)
if true then
if not settings.s then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horatauz.ogg")
end
end

testee = addButton("t", "Musica 1", true, leftPanel)
if true then
if not settings.t then end
  testee.onClick = function(widget)
playSound("/data/sounds/1.ogg")
end
end

testee = addButton("v", "Musica 2", true, leftPanel)
if true then
if not settings.v then end
  testee.onClick = function(widget)
playSound("/data/sounds/2.ogg")
end
end

testee = addButton("x", "Musica 3", true, leftPanel)
if true then
if not settings.x then end
  testee.onClick = function(widget)
playSound("/data/sounds/billie.ogg")
end
end

testee = addButton("y", "Musica 4", true, leftPanel)
if true then
if not settings.y then end
  testee.onClick = function(widget)
playSound("/data/sounds/dead.ogg")
end
end


testee = addButton("z", "Musica 5", true, leftPanel)
if true then
if not settings.z then end
  testee.onClick = function(widget)
playSound("/data/sounds/dogs.ogg")
end
end

testee = addButton("w", "Musica 6", true, leftPanel)
if true then
if not settings.w then end
  testee.onClick = function(widget)
playSound("/data/sounds/gang.ogg")
end
end


testee = addButton("aa", "Musica 7", true, leftPanel)
if true then
if not settings.aa then end
  testee.onClick = function(widget)
playSound("/data/sounds/havana.ogg")
end
end

testee = addButton("ab", "Musica 8", true, leftPanel)
if true then
if not settings.ab then end
  testee.onClick = function(widget)
playSound("/data/sounds/lil.ogg")
end
end

testee = addButton("ac", "Musica 9", true, leftPanel)
if true then
if not settings.ac then end
  testee.onClick = function(widget)
playSound("/data/sounds/sadnes.ogg")
end
end

testee = addButton("ad", "Musica 10", true, leftPanel)
if true then
if not settings.ad then end
  testee.onClick = function(widget)
playSound("/data/sounds/theory.ogg")
end
end


testee = addButton("ae", "Musica 11", true, leftPanel)
if true then
if not settings.ae then end
  testee.onClick = function(widget)
playSound("/data/sounds/umut.ogg")
end
end

testee = addButton("af", "Musica 12", true, leftPanel)
if true then
if not settings.af then end
  testee.onClick = function(widget)
playSound("/data/sounds/venom.ogg")
end
end

testee = addButton("ag", "Musica 13", true, leftPanel)
if true then
if not settings.ag then end
  testee.onClick = function(widget)
playSound("/data/sounds/waka.ogg")
end
end

testee = addButton("ah", "Musica 14", true, leftPanel)
if true then
if not settings.ah then end
  testee.onClick = function(widget)
playSound("/data/sounds/week.ogg")
end
end

testee = addButton("ai", "Musica 15", true, leftPanel)
if true then
if not settings.ai then end
  testee.onClick = function(widget)
playSound("/data/sounds/50cent.ogg")
end
end

testee = addButton("aj", "1 hora sad", true, leftPanel)
if true then
if not settings.aj then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horasad.ogg")
end
end

testee = addButton("ak", "1 hora de musica", true, leftPanel)
if true then
if not settings.ak then end
  testee.onClick = function(widget)
playSound("/data/sounds/1hora.ogg")
end
end


testee = addButton("al", "1 hora de Neffex", true, leftPanel)
if true then
if not settings.al then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horaneffex.ogg")
end
end

testee = addButton("am", "1 hora de Link Park", true, leftPanel)
if true then
if not settings.am then end
  testee.onClick = function(widget)
playSound("/data/sounds/1horalink.ogg")
end
end



extrasWindow.stopp.onClick = function(widget)
playSound("/sounds/yamate.ogg")
end
